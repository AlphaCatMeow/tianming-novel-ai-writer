## P.s：不需要刻意进群，开源版自己部署，不需要卡密，开源说明中有明确的去处登录卡密的方式，查看 开源说明.md，如果连中文都看不明白，不建议使用。正式版测试结束，交流群现在作为开源互助群。
请查看介绍中的【重点缺失】部分（因为旧版源码我都删除了，懒得重新下载修复在上传了）
## 交流群
...
开源版必须修复的，让AI修复就可以，1和2必须修复，才能稳定生成，

1：修复CHANGESS中英映射BUG，导致校验的时候模型识别不出
2：修复漏报重写反馈维度注入
3：去除了Beta版UN-UTF-8，加入Console.OutputEncoding(开源版没修改，
可以让AI帮忙修改下，很简单，十来行代码）
4：强化状态机，不会过早记录，导致模型误判
